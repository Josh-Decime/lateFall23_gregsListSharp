...
VALUES -- ("Barney", "brown", "rolling in mud", true, "worms", 6);
...
VALUES -- ('Luigi', 'Kart', 2019, 50, "Wawhhwhahwhwaa", 'https://images.unsplash.com/photo-1599409673963-8f304a658f4e?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D', '#00ff00');
    ...
    (
        ...
        2000,
        10000,
        "Jeremy drives this to school each day, and drifts around the Micky D's drive through.",
        'https://images.unsplash.com/photo-1552615526-40e47a79f9d7?q=80&w=2176&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D',
        '#ffff00'
    );
SELECT *
FROM cars
